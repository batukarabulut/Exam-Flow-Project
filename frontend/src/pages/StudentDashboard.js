...
import {
  Container, Typography, Box, Card, CardContent, Grid, AppBar, Toolbar,
  Button, Alert, CircularProgress, Chip, Avatar
} from '@mui/material';
import {
  School, Event, Schedule, Person, Logout, CalendarToday, Room
                    ...
                    <Card sx={{ height: '100%' }}>
                      <CardContent>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2 }}>
                          ...
                          <Chip label={exam.status} color={getExamStatusColor(exam.status)} size="small" />
                        </Box>
                      ...
                      <Card sx={{ opacity: 0.7 }}>
                        <CardContent>
                          ...
                          <Typography variant="body2" color="text.secondary">
                            {exam.course_detail?.code} - {formatDate(exam.date)}
                          </Typography>
                        </CardContent>
                      </Card>
                    </Grid>
